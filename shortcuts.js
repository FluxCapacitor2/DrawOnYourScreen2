...
var GLOBAL_KEYBINDINGS_SWITCHES = [
    'persistent-over-toggles', 'persistent-over-restarts', 'drawing-on-desktop', 'osd-disabled', 'indicator-disabled', 'indicator-always-visible', 'right-click-to-erase', 'corner-buttons'
];
